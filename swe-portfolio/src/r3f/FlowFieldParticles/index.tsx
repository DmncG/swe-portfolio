    ...
    Suzanne: folder(
      {
        ...
        suzanne_repulsionForce: { label: "Repulsion Force", value: 0.5, min: 0.0, max: 1 },
    ...
    Gorilla: folder(
      {
        ...
        gorilla_repulsionForce: { label: "Repulsion Force", value: 0.5, min: 0.0, max: 1 },
    ...
    Pug: folder(
      {
        ...
        pug_repulsionForce: { label: "Repulsion Force", value: 0.5, min: 0.0, max: 1 },
...
export const TestFlowFieldParticles = () => {
  return (
